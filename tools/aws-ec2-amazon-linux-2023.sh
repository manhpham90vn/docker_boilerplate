...
# Install php
sudo dnf install -y php php8.1-fpm php8.1-cli php8.1-mysqlnd php8.1-bcmath php8.1-devel php8.1-pdo php8.1-common php8.1-gd php8.1-mbstring php8.1-xml php8.1-intl php-pear
